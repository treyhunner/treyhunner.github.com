...
$(document).on("click", "#funnel-tools-capture .title, #funnel-tools-capture .open", function(){
  FunnelTools.Capture.show();
});

$(document).on("click", "#funnel-tools-capture .close", function(){
